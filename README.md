...
| 温湿度传感器 | SHT30 | I2C (I2C 5, 地址 0x44) | 温度 ±0.3°C, 湿度 ±2% RH |
| 烟雾传感器 | MQ-2 | ADC (ADC 1, 12bit) | 检测液化气/丙烷/氢气浓度 |
| 红外传感器 | HC-SR501 | GPIO (GPIO 388) | 人体红外感应，感应角度 <120° |
...
2. 中枢文件通过 `napi_module_register` 注册为单一 `@ohos.guardsys_napi` 模块
